...
main(int argc, char *argv[])
{
  ...
  1a:	68 38 0b 00 00       	push   $0xb38
  1f:	6a 02                	push   $0x2
  21:	e8 9a 06 00 00       	call   6c0 <printf>
    exit(1);
  26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2d:	e8 d6 04 00 00       	call   508 <exit>
  }
  ...
  3a:	e8 29 05 00 00       	call   568 <link>
  ...
  49:	6a 00                	push   $0x0
  4b:	e8 b8 04 00 00       	call   508 <exit>
  if(argc != 3){
    printf(2, "Usage: ln old new\n");
    exit(1);
  }
  ...
  56:	68 4b 0b 00 00       	push   $0xb4b
  5b:	6a 02                	push   $0x2
  5d:	e8 5e 06 00 00       	call   6c0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 647:	f7 f1                	div    %ecx
 649:	0f b6 92 68 0b 00 00 	movzbl 0xb68(%edx),%edx
  }while((x /= base) != 0);
...
printstr(int fd, char *str)
{
  ...
  if (str == 0)
    str = "(null)";
 813:	b8 5f 0b 00 00       	mov    $0xb5f,%eax
