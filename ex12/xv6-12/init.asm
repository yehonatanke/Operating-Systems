...
main(void)
{
  ...
  12:	6a 02                	push   $0x2
  14:	68 08 0c 00 00       	push   $0xc08
  19:	e8 fa 05 00 00       	call   618 <open>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	0f 88 e5 00 00 00    	js     10e <main+0x10e>
    mknod("console", 1, 0);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 1d 06 00 00       	call   650 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 11 06 00 00       	call   650 <dup>

  mknod("tty0", 1, 1);
  3f:	83 c4 0c             	add    $0xc,%esp
  42:	6a 01                	push   $0x1
  44:	6a 01                	push   $0x1
  46:	68 10 0c 00 00       	push   $0xc10
  4b:	e8 d0 05 00 00       	call   620 <mknod>
  mknod("tty1", 1, 2);
  50:	83 c4 0c             	add    $0xc,%esp
  53:	6a 02                	push   $0x2
  55:	6a 01                	push   $0x1
  57:	68 15 0c 00 00       	push   $0xc15
  5c:	e8 bf 05 00 00       	call   620 <mknod>
  mknod("tty2", 1, 3);
  61:	83 c4 0c             	add    $0xc,%esp
  64:	6a 03                	push   $0x3
  66:	6a 01                	push   $0x1
  68:	68 1a 0c 00 00       	push   $0xc1a
  6d:	e8 ae 05 00 00       	call   620 <mknod>
  ...
  7b:	68 1f 0c 00 00       	push   $0xc1f
  80:	6a 01                	push   $0x1
  82:	e8 09 07 00 00       	call   790 <printf>
    pid = fork();
  87:	e8 44 05 00 00       	call   5d0 <fork>
    if(pid < 0){
  ...
  91:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  93:	78 34                	js     c9 <main+0xc9>
      printf(1, "init: fork failed\n");
      exit(1);
    }
    if(pid == 0){
  95:	74 4c                	je     e3 <main+0xe3>
  ...
  a3:	6a 00                	push   $0x0
  a5:	e8 36 05 00 00       	call   5e0 <wait>
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	85 c0                	test   %eax,%eax
  af:	78 c7                	js     78 <main+0x78>
  b1:	39 c3                	cmp    %eax,%ebx
  b3:	74 c3                	je     78 <main+0x78>
      printf(1, "zombie!\n");
  b5:	83 ec 08             	sub    $0x8,%esp
  b8:	68 5e 0c 00 00       	push   $0xc5e
  bd:	6a 01                	push   $0x1
  bf:	e8 cc 06 00 00       	call   790 <printf>
  c4:	83 c4 10             	add    $0x10,%esp
  c7:	eb d7                	jmp    a0 <main+0xa0>
  ...
  c9:	53                   	push   %ebx
  ca:	53                   	push   %ebx
  cb:	68 32 0c 00 00       	push   $0xc32
  d0:	6a 01                	push   $0x1
  d2:	e8 b9 06 00 00       	call   790 <printf>
      exit(1);
  d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  de:	e8 f5 04 00 00       	call   5d8 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  e3:	50                   	push   %eax
  e4:	50                   	push   %eax
  e5:	68 00 20 00 00       	push   $0x2000
  ea:	68 45 0c 00 00       	push   $0xc45
  ef:	e8 1c 05 00 00       	call   610 <exec>
      printf(1, "init: exec sh failed\n");
  f4:	5a                   	pop    %edx
  f5:	59                   	pop    %ecx
  f6:	68 48 0c 00 00       	push   $0xc48
  fb:	6a 01                	push   $0x1
  fd:	e8 8e 06 00 00       	call   790 <printf>
      exit(1);
 102:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 109:	e8 ca 04 00 00       	call   5d8 <exit>
main(void)
{
  int pid, wpid;
 ...
 10f:	6a 00                	push   $0x0
 111:	6a 01                	push   $0x1
 113:	68 08 0c 00 00       	push   $0xc08
 118:	e8 03 05 00 00       	call   620 <mknod>
    open("console", O_RDWR);
 11d:	58                   	pop    %eax
 11e:	5a                   	pop    %edx
 11f:	6a 02                	push   $0x2
 121:	68 08 0c 00 00       	push   $0xc08
 126:	e8 ed 04 00 00       	call   618 <open>
 12b:	83 c4 10             	add    $0x10,%esp
 12e:	e9 f6 fe ff ff       	jmp    29 <main+0x29>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 717:	f7 f1                	div    %ecx
 719:	0f b6 92 70 0c 00 00 	movzbl 0xc70(%edx),%edx
  }while((x /= base) != 0);
...
printstr(int fd, char *str)
{
  ...
  if (str == 0)
    str = "(null)";
 8e3:	b8 67 0c 00 00       	mov    $0xc67,%eax
...
free(void *ap)
{
 ...
 941:	a1 08 20 00 00       	mov    0x2008,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 997:	89 08                	mov    %ecx,(%eax)
  freep = p;
 999:	a3 08 20 00 00       	mov    %eax,0x2008
}
 99e:	5b                   	pop    %ebx
 99f:	5e                   	pop    %esi
 9a0:	5f                   	pop    %edi
 ...
 9ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 9bd:	a3 08 20 00 00       	mov    %eax,0x2008
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 15 08 20 00 00    	mov    0x2008,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 a2f:	76 3f                	jbe    a70 <malloc+0xa0>
    ...
    if(p == freep)
 a31:	39 05 08 20 00 00    	cmp    %eax,0x2008
 ...
 a56:	e8 e5 fe ff ff       	call   940 <free>
  return freep;
 a5b:	8b 15 08 20 00 00    	mov    0x2008,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 a7c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 a7f:	89 15 08 20 00 00    	mov    %edx,0x2008
      return (void*)(p + 1);
 ...
 a94:	eb e9                	jmp    a7f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a96:	c7 05 08 20 00 00 0c 	movl   $0x200c,0x2008
 a9d:	20 00 00 
 aa0:	c7 05 0c 20 00 00 0c 	movl   $0x200c,0x200c
 aa7:	20 00 00 
    base.s.size = 0;
 aaa:	b8 0c 20 00 00       	mov    $0x200c,%eax
 aaf:	c7 05 10 20 00 00 00 	movl   $0x0,0x2010
 ab6:	00 00 00 
