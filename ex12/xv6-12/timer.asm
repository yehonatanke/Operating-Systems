...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        printf(1, "seconds: %d\n", i);
  24:	6a 01                	push   $0x1
  26:	e8 65 06 00 00       	call   690 <printf>
        usleep(1 * 1000 * 1000);
  2b:	c7 04 24 40 42 0f 00 	movl   $0xf4240,(%esp)
  32:	e8 69 05 00 00       	call   5a0 <usleep>
        ++i;
  37:	83 c4 10             	add    $0x10,%esp
  3a:	eb dc                	jmp    18 <main+0x18>
  3c:	66 90                	xchg   %ax,%ax
  3e:	66 90                	xchg   %ax,%ax
...
printstr(int fd, char *str)
{
  ...
  if (str == 0)
    str = "(null)";
 7e3:	b8 15 0b 00 00       	mov    $0xb15,%eax
